...
contract("Token", ([deployer, receiver, exchange]) => {
  ...
  describe("deployment", () => {
    ...
    it("tracks the balance of token", async () => {
  ...
  describe("sending tokens", () => {
    ...
    describe("success", () => {
      ...
      it("transfers token balances", async () => {
        ...
        balanceOf.toString().should.equal(tokens(800).toString());
      ...
      it("emits a Transfer event", async () => {
        ...
        event.to.toString().should.equal(receiver, "too is correct");
        event.value
          .toString()
          .should.equal(amount.toString(), "too is correct");
      });
    });
    ...
    describe("failure", () => {
      it("rejects insufficient balances", async () => {
        let invalidAmount;
        invalidAmount = tokens(500000);
        await token
          .transfer(receiver, invalidAmount, { from: deployer })
          .should.be.rejectedWith(EVM_REVERT);

        invalidAmount = tokens(2000);
        await token
